...
BinaryTree::size(const BinaryNode * subtree)
{
	...
	{
		temp = 1 + size(subtree->right_) + size(subtree->left_);
	}
	return  temp;
}
...
BinaryTree::height(const BinaryNode * subtree)
{
	...
	{
		temp = 1 + height(subtree->left_);
	}
	else if (height(subtree->left_) < height(subtree->right_))
	{
		temp = 1 + height(subtree->right_);
	}
	return  temp;
}
...
BinaryTree::leaves(const BinaryNode * subtree)
{
	...
	if ((subtree-> left_ == NULL) && (subtree-> left_ == NULL))
	{
		return 1;
	}
	else
	...
	//else if ((subtree->left_ != NULL) && (subtree->left_ == NULL))
	//{
	//	temp += leaves(subtree->left_);
	//}
	//else if ((subtree->left_ == NULL) && (subtree->left_ != NULL))
	//{
	//	temp += leaves(subtree->right_);
	//}
	//return  temp;
}
